...
<script type='text/javascript' src ="custBooking.js"></script>
...
<body>
    ...
    <?php 
    $sql = "SELECT booking_starttime FROM booking b join customer c ON b.cust_email = c.cust_firstname where c.cust_email = '$_SESSION[Email]'";
